    ...
    <div>
      ...
      <div className="p-12">
        ...
        <div className="overflow-x-auto rounded-card border border-border">
          <div className="grid min-w-[600px] grid-cols-[1fr_120px_140px_120px] gap-4 bg-elevated px-5 py-3.5 font-sans text-[11px] font-bold tracking-[0.08em] text-faint">
            <div>USER</div>
            <div>ROLE</div>
            <div>JOINED</div>
            <div>ACTIONS</div>
          ...
          {users.map((u) => (
            <div
              key={u.id}
              className="grid min-w-[600px] grid-cols-[1fr_120px_140px_120px] items-center gap-4 border-t border-border px-5 py-4"
            >
              <div>
